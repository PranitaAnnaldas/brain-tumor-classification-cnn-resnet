...
1. Clone this repository:  
   git clone \[https://github.com/PranitaAnnaldas/brain-tumor-classification-cnn-resnet.git\](https://github.com/PranitaAnnaldas/brain-tumor-classification-cnn-resnet.git)
